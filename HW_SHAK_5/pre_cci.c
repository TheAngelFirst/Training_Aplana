# 1 "c:\\users\\angel\\documents\\github\\training_aplana\\hw_shak_5\\\\combined_HW_SHAK_5.c"
...
# 1 "c:\\users\\angel\\documents\\github\\training_aplana\\hw_shak_5\\\\combined_HW_SHAK_5.c" 2
...
# 2 "c:\\users\\angel\\documents\\github\\training_aplana\\hw_shak_5\\\\combined_HW_SHAK_5.c" 2
...
# 3 "c:\\users\\angel\\documents\\github\\training_aplana\\hw_shak_5\\\\combined_HW_SHAK_5.c" 2
...
# 4 "c:\\users\\angel\\documents\\github\\training_aplana\\hw_shak_5\\\\combined_HW_SHAK_5.c" 2
...
Action()
{
	...
	web_submit_data("login.pl", 
		...
		"LAST");
	lr_end_transaction("T11_Login",2);
	...
	web_url("welcome.pl", 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("T12_Search_Flights_Button",2);
	...
	web_submit_data("reservations.pl", 
		...
		"LAST");
	lr_end_transaction("T13_Find_Flight",2);
	...
	web_submit_data("reservations.pl_2", 
		...
		"LAST");
	lr_end_transaction("T14_Choose_flight",2);
	...
	web_submit_data("reservations.pl_3", 
		...
		"LAST");
	lr_end_transaction("T15_Ticket_payment",2);
	...
	web_url("Itinerary Button", 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("T17_Itinerary_Button",2);
	...
	web_url("SignOff Button", 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("T20_Logout",2);
	
	lr_end_transaction("S5_Buy_roundtrip_tickets", 2);

	return 0;
}
# 5 "c:\\users\\angel\\documents\\github\\training_aplana\\hw_shak_5\\\\combined_HW_SHAK_5.c" 2
...
# 6 "c:\\users\\angel\\documents\\github\\training_aplana\\hw_shak_5\\\\combined_HW_SHAK_5.c" 2
